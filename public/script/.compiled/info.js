...
(function() {
  ...
  window.Info = Info = (function() {
    ...
    function Info() {
      ...
      $('#info').on('change', 'select', function() {
        var album_id, rating;
        ...
        return jQuery.ajax({
          ...
          success: function(data) {
            if (data.success) {
              _cache.albums[album_id].rating = rating.toNum();
            }
            return console.log(_cache.albums[album_id]);
          }
        });
      });
