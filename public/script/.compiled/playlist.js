...
(function() {
  ...
  window.Playlist = Playlist = (function() {
    ...
    Playlist.prototype.cleanCache = function() {
      var albums, artists, deleted, k, t, tracks, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _results;
      tracks = [];
      albums = [];
      artists = [];
  ...
  selectBox = function(target) {
    ...
    return $('body').on('mousemove.selectbox', function(e) {
      var b, from, h, l, offs, r, row, t, to, w, _base, _base1, _i, _len, _ref, _ref1;
      if (!dragging && maystart && (Math.abs(startX - e.pageX) > 5 || Math.abs(startY - e.pageY) > 5)) {
        ...
        if ((_ref = document.selection) != null) {
          _ref.empty();
        }
        document.body.focus();
        e.preventDefault();
      ...
      if (row.length > 0) {
        ...
        if (("" + from + "-" + to) !== ("" + prev.from + "-" + prev.to)) {
          ...
          _ref1 = $('#playlist tbody tr').slice(from, to);
