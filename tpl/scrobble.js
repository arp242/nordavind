(function() {
  ...
  Scrobble = (function() {
    ...
    */
    ...
    function Scrobble() {
      if (window.localStorage.getItem('nordavind_lastfm')) this.enabled = true;
    }
    ...
    */
    ...
    Scrobble.prototype._req = function(paramsobj, cb, type) {
      ...
      if (session != null) paramsobj['sk'] = session.key;
      params = (function() {
        var _results;
        _results = [];
        for (k in paramsobj) {
      ...
      sig = md5(((function() {
        ...
        for (_i = 0, _len = params.length; _i < _len; _i++) {
          ...
          if (k !== 'format' && k !== 'callback') _results.push("" + k + v);
        }
        return _results;
      })()).join('') + this.secret);
      urlparams = ((function() {
      ...
      return jQuery.ajax({
        ...
        success: function(data) {
          ...
          if (cb) return cb.call(null, data);
        }
      });
    };
